...
(function() {
  var BUTTON_HTML, display_normal, display_sidebyside, fetch_url, find_diff_url, main, previous_raw_link_base, url_unescape,
    __slice = [].slice;
  ...
  display_sidebyside = function($button, $diff_table, $container, current_raw_path, relative_path, change_set) {
    var $content, current, parent, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    ...
    (function(__iced_k) {
      ...
      return $button.removeClass('sidebyside').addClass('normaldiff').text('Normal');
    });
  };

  display_normal = function($button, $diff_table, $container) {
    $container.find('table.diff').remove();
    $container.append($diff_table);
    return $button.removeClass('normaldiff').addClass('sidebyside').text('Side-by-Side');
  };
  ...
  main = function() {
    ...
    (function(__iced_k) {
      ...
      return $('.diff-view .file').each(function(_index, elem) {
        ...
        $(elem).find('.meta').on('dblclick', function(e) {
          return $container.toggle();
        });
        $button.on('click', '.sidebyside', function(e) {
          e.preventDefault();
          return display_sidebyside($(e.target), $diff_table, $container, current_raw_path, relative_path, change_set);
        });
        $button.on('click', '.normaldiff', function(e) {
          e.preventDefault();
          return display_normal($(e.target), $diff_table, $container);
        });
